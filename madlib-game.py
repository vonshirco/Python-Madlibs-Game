#import module
from tkinter import *  #(importing the required modules, here we import tkinter module.)

# initialize window
root = Tk() #initialized tkinter which means window created
root.geometry('300x300') #used when we want to set the width and height of the window
root.title('DataFlair-Mad Libs Generator') #used to give the title of the window
Label(root, text= 'Mad Libs Generator \n Have Fun!' , font = 'arial 20 bold').pack() #widget use to display text that users can’t able to modify
...
def madlib1(): #Photographer madlib
...
def madlib3(): #The butterfly madlib
...
#Buttons - widget used to display buttons on our tkinter window  
Button(root, text= 'The Photographer', font ='arial 15', command= madlib1, bg = 'ghost white').place(x=60, y=120)
Button(root, text= 'An Apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=70, y=180)
